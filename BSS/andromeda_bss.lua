...
local library = api.returncode("https://cdn.statically.io/gh/wantll/aalu/main/API/bracketv3.lua")
...
information:CreateLabel("Place version: "..game.PlaceVersion)
information:CreateLabel("Script by wantll, .anon and a10b")
...
information:CreateButton("Donation", function() setclipboard("https://qiwi.com/n/wantll") end)
...
farmo:CreateToggle("Autodig", true, function(State) andromeda.toggles.autodig = State end)
farmo:CreateToggle("Auto Sprinkler", true, function(State) andromeda.toggles.autosprinkler = State end)
...
farmo:CreateToggle("Farm Under Clouds",  true, function(State) andromeda.toggles.farmclouds = State end)
...
farmt:CreateToggle("Auto Wealth Clock", true, function(State) andromeda.toggles.clock = State end)
...
farmt:CreateToggle("Auto Free Antpasses",  true, function(State) andromeda.toggles.freeantpass = State end)
...
mobkill:CreateToggle("Avoid Mobs",  true, function(State) andromeda.toggles.avoidmobs = State end)
...
local wstoggle = miscc:CreateToggle("Walk Speed",  true, function(State) andromeda.toggles.loopspeed = State end) wstoggle:CreateKeybind("K", function(Key) end)
local jptoggle = miscc:CreateToggle("Jump Power",  true, function(State) andromeda.toggles.loopjump = State end) jptoggle:CreateKeybind("L", function(Key) end)
...
extras:CreateButton("Hide nickname", function() loadstring(game:HttpGet("https://cdn.statically.io/gh/wantll/aalu/main/UTILITES/nicknamespoofer.lua"))()end)
extras:CreateButton("Boost FPS", function()loadstring(game:HttpGet("https://cdn.statically.io/gh/wantll/aalu/main/UTILITES/fpsboost.lua"))()end)
extras:CreateButton("Destroy Decals", function()loadstring(game:HttpGet("https://cdn.statically.io/gh/wantll/aalu/main/UTILITES/destroydecals.lua"))()end)
...
farmsettings:CreateToggle("^ Loop Speed On Autofarming", true, function(State) andromeda.toggles.loopfarmspeed = State end)
farmsettings:CreateToggle("Don't Walk In Field",nil, function(State) andromeda.toggles.farmflower = State end)
farmsettings:CreateToggle("Convert Hive Balloon", true, function(State) andromeda.toggles.convertballoons = State end)
farmsettings:CreateToggle("Don't Farm Tokens",nil, function(State) andromeda.toggles.donotfarmtokens = State end)
farmsettings:CreateSlider("Walk Speed", 0, 120, 50, false, function(Value) andromeda.vars.walkspeed = Value end)
farmsettings:CreateSlider("Jump Power", 0, 120, 90, false, function(Value) andromeda.vars.jumppower = Value end)
...
dispsettings:CreateToggle("Royal Jelly Dispenser",  true, function(State) andromeda.dispensesettings.rj = not andromeda.dispensesettings.rj end)
dispsettings:CreateToggle("Blueberry Dispenser",  true,  function(State) andromeda.dispensesettings.blub = not andromeda.dispensesettings.blub end)
dispsettings:CreateToggle("Strawberry Dispenser",  true,  function(State) andromeda.dispensesettings.straw = not andromeda.dispensesettings.straw end)
dispsettings:CreateToggle("Treat Dispenser",  true,  function(State) andromeda.dispensesettings.treat = not andromeda.dispensesettings.treat end)
dispsettings:CreateToggle("Coconut Dispenser",  true,  function(State) andromeda.dispensesettings.coconut = not andromeda.dispensesettings.coconut end)
dispsettings:CreateToggle("Glue Dispenser",  true,  function(State) andromeda.dispensesettings.glue = not andromeda.dispensesettings.glue end)
...
dispsettings:CreateToggle("Blue Field Booster",  true,  function(State) andromeda.dispensesettings.blue = not andromeda.dispensesettings.blue end)
dispsettings:CreateToggle("Red Field Booster",  true,  function(State) andromeda.dispensesettings.red = not andromeda.dispensesettings.red end)
